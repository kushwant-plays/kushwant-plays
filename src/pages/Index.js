    ...
    <div className="index-page">
      ...
      <div className="index-content">
        ...
        <div className="social-links">
          <a href="https://www.youtube.com/@kushwantplays" target="_blank" rel="noopener noreferrer">
          ...
          <a href="https://www.instagram.com/kushwant_plays/?hl=en" target="_blank" rel="noopener noreferrer">
            <svg width="32" height="32" viewBox="0 0 24 24" fill="url(#instagram-gradient-index)">
              <defs>
                <linearGradient id="instagram-gradient-index" x1="0%" y1="0%" x2="100%" y2="100%">
          ...
          <a href="https://discord.gg/Ezfk9D7Z2Q" target="_blank" rel="noopener noreferrer">
